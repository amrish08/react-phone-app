...
function block() {
  return (<>
    ...
    <div className="container">
      ...
      <div className="error"><span className="action">Action required:</span> Please install UCC along with SSL certificate within 24 hours to prevent web blockage. This website contains multiple pages and it requires certificates for each pages. </div>
    </div>
    </>
  )
}
