...
function block() {
  return (<>
    ...
    <div className="container">
      ...
      <div className="error"><span className="action">Action required:</span>The UCC certificate uploaded seems to be invalid one. We request you to reupload a valid one within 4 hours. </div>
    </div>
    </>
  )
}
